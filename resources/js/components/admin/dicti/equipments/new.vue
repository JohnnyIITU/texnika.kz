<template>
    <div>
        <form action="">
            ...
            <div class="flex justify-content-center form-group">
                <button class="btn btn-info btn-lg mt-2" type="button" @click="create">Применить</button>
            </div>
        </form>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            create() {
                ...
                this.axios.post('/equipments/add', {name: this.fullname})
                    .then(response => {
